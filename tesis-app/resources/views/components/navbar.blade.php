...
<header class="bg-white shadow-lg">
    <nav class="flex justify-between items-center max-w-screen-xl mx-auto p-6">
        ...
        <div class="hidden md:flex ml-10 space-x-8">
            <ul class="flex items-center space-x-4">
                <li>
                    <a href="{{ route('home')}}" class="text-sm text-gray-700 hover:text-indigo-600 transition duration-300 flex items-center">
                ...
                <li>
                    <a href="{{ route('nosotros')}}" class="text-sm text-gray-700 hover:text-indigo-600 transition duration-300 flex items-center">
                        <i class="fa-solid fa-users mr-2"></i>
                        Sobre Nosotros
                    </a>
                </li>
                <li>
                    <a href="{{ route('contacto')}}" class="text-sm text-gray-700 hover:text-indigo-600 transition duration-300 flex items-center">
        ...
        <div class="hidden md:flex ml-10">
            <ul class="flex gap-6">
                <li>
                    <a href=" {{ route('login') }} " class="text-sm text-gray-700 hover:text-indigo-600 transition duration-300 flex items-center">
    ...
    <div id="mobileMenu" class="hidden md:hidden bg-white shadow-lg">
        <ul class="space-y-4 p-6">
            <li>
                <a href=" {{ route('home')}}" class="text-gray-700 hover:text-indigo-600 transition duration-300 flex items-center">
                    <i class="fa-solid fa-house mr-2"></i>
                    Inicio
                </a>
            </li>
            ...
            <li>
                <a href=" {{  route('nosotros')}}" class="text-gray-700 hover:text-indigo-600 transition duration-300 flex items-center">
                    <i class="fa-solid fa-users mr-2"></i>
                    Vacantes
                </a>
            </li>
            <li>
                <a href=" {{ route('contacto')}}" class="text-gray-700 hover:text-indigo-600 transition duration-300 flex items-center">
                    <i class="fa-solid fa-phone"></i>
                    Contáctanos
                </a>
            </li>
